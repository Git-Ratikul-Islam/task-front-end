...
const Home = () => {
      ...
      return (
            <div className="lg:max-w-[1850px] md:max-w-screen-2xl sm:max-w-screen-md mx-auto ">
                  <div className="grid custom-scrollbar-design grid-cols-6 gap-96 overflow-x-scroll  scrolling-touch scrollbar-thumb-[#147cc3] scrollbar-track-[#bbbbbb] scrollbar-thin items-start">
